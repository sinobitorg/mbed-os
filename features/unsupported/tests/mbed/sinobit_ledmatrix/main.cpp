...
static unsigned char show[24] = { 0b11111111, 0b11110000, 0b11111100, 0b00010000, 0b11111100, 0b00010000, 0b11111111, 0b10010000, 0b11111111, 0b10010000, 0b11111111, 0b10010000, 0b10011111, 0b11110000, 0b10011111, 0b11110000, 0b10011111, 0b11110000, 0b10000011, 0b11110000, 0b10000011, 0b11110000, 0b11111111, 0b11110000 };
static unsigned char show1[24] = { 0b11111111, 0b11110000, 0b10000011, 0b11110000, 0b10000011, 0b11110000, 0b10011111, 0b11110000, 0b10011111, 0b11110000, 0b10011111, 0b11110000, 0b11111111, 0b10010000, 0b11111111, 0b10010000, 0b11111111, 0b10010000, 0b11111100, 0b00010000, 0b11111100, 0b00010000, 0b11111111, 0b11110000};
static unsigned char com[12] = {0x00,0x04,0x08,0x0C,0x10,0x14,0x18,0x1C,0x20,0x24,0x28,0x2C};

static unsigned char show2[24] ;
static unsigned char show3[24];
...
int main() {
    ...
    wait(0.5);
    pc->printf("SINOBIT TEST MBED_40\n");

    HT1632C_Init();
    HT1632C_clr();
    
    memcpy(&show2,&show,24);
    memcpy(&show3,&show1,24);
    ...
    for (int n =0;n<10;n++) 
    {
        ...
        memcpy(&show3,&show1,24);
        for(int i=0; i<12; i++) {
            HT1632C_Write_DAT(com[i],show2,i+1);
        }
        wait(0.5);
        
        for(int i=0; i<12; i++) {
            HT1632C_Write_DAT(com[i],show3,i+1);
        }
        wait(0.5);
     
    }
    pc->printf("SINOBIT TEST MBED_40 DONE.\n");
    while (1) {
